    ...
    >
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="hidden md:flex justify-between items-center px-10 ">
          <div
            href="/"
            className="text-primary font-semibold flex gap-1 items-center"
          >
          ...
          <div className="flex items-center gap-x-6">
            ...
            <ul className="flex items-center cursor-pointer gap-8 text-black font-semibold">
              <li className="hover:text-red-500 transition-all" to={"/"}>
                Home
              </li>
              <li className="hover:text-red-500 transition-all" to={"#menu"}>
                Menu
              </li>
              <li className="hover:text-red-500 transition-all" to={"#about"}>
                About
              </li>
              <li className="hover:text-red-500 transition-all" to={"#contact"}>
                Contact
              </li>
              <button className="bg-red-500 hover:bg-red-700 px-4 py-2  text-white rounded-lg">
                Order Now
              </button>
            </ul>
          </div>
